            ...
            >
              ...
              <div className="relative p-8">
                <div className="mb-6 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500/20 to-blue-500/20">
                  {/* Iconni tanlash logikasi. Bu yerda t.cases.items ichida iconType kalitini qo'shish kerak */}
                  {caseItem.iconType === "FlaskConical" && (
                    <FlaskConical className="h-7 w-7 text-purple-400" />
                  )}
                  {caseItem.iconType === "Building2" && (
                    <Building2 className="h-7 w-7 text-purple-400" />
                  )}
                  {caseItem.iconType === "ShoppingCart" && (
